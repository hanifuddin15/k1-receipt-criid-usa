...
class CheckSubCatReamingController extends GetxController {

  RxList<Datum> subcatList = <Datum>[].obs;

  var cat_id = ''.obs;
  final loader=false.obs;
  final reaming =false.obs;

  void setcat_name(String value) => cat_id.value = value;

  Future<void> getReamingSubCat(String catid) async {
    print("::::::::: ${catid} ${user_id}");
    ...
    final url = Uri.parse(
      'http://dev.k1receipt.com/api/plan-upgrade-check/$catid/sub_category',
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final subcatreaming = jsonData['data']['sub_category_remaining'];

        print("::::::::::::::::::::;sub cat list ${subcatreaming}");
        if(subcatreaming.toString()=="0"){
