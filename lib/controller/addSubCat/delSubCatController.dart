...
class DeleteSubCatController extends GetxController {
  ...
  Future<void> deleteSubCat(String catid,String budgetid) async {
    ...
    //api/category/{category_id}/{budget_id}/delete

    final url = Uri.parse('https://$baseurl/api/subcategory/$catid/$budgetid/delete',);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Get.snackbar(
          ...
          'Your catagory ${cat_name.value} Deleted successfully',
