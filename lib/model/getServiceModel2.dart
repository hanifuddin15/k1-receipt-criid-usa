...
GetServicesOfPlan2 getServicesOfPlan2FromJson(String str) => GetServicesOfPlan2.fromJson(json.decode(str));

String getServicesOfPlan2ToJson(GetServicesOfPlan2 data) => json.encode(data.toJson());

class GetServicesOfPlan2 {
  bool error;
  String msg;
  List<Datum> data;
  ...
  factory GetServicesOfPlan2.fromJson(Map<String, dynamic> json) => GetServicesOfPlan2(
    error: json["error"],
    msg: json["msg"],
