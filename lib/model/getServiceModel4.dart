...
GetServicesOfPlan4 getServicesOfPlan4FromJson(String str) => GetServicesOfPlan4.fromJson(json.decode(str));

String getServicesOfPlan4ToJson(GetServicesOfPlan4 data) => json.encode(data.toJson());

class GetServicesOfPlan4 {
  bool error;
  String msg;
  List<Datum> data;
  ...
  factory GetServicesOfPlan4.fromJson(Map<String, dynamic> json) => GetServicesOfPlan4(
    error: json["error"],
    msg: json["msg"],
