...
GetServicesOfPlan1 getServicesOfPlan1FromJson(String str) => GetServicesOfPlan1.fromJson(json.decode(str));

String getServicesOfPlan1ToJson(GetServicesOfPlan1 data) => json.encode(data.toJson());

class GetServicesOfPlan1 {
  bool error;
  String msg;
  List<Datum> data;
  ...
  factory GetServicesOfPlan1.fromJson(Map<String, dynamic> json) => GetServicesOfPlan1(
    error: json["error"],
    msg: json["msg"],
